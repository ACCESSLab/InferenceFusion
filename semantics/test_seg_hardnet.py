...
def pedestrian_mask(semantic_frame):
    ...
    '''
    lower_purple = np.array([70, 130, 50])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--weight", type=str, default='checkpoints/pretrained/hardnet/hardnet70_cityscapes.pth')
    # parser.add_argument("--output", type=str, default='sem_map_hardnet_greensboro.pkl')
    parser.add_argument("--output", type=str, default='./all_pkl_files/sem_map_hardnet_CityPersons.pkl')
